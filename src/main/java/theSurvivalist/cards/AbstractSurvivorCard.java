...
import theSurvivalist.util.CardArtRoller;

import java.util.ArrayList;

import static theSurvivalist.SurvivalMod.getModID;
import static theSurvivalist.SurvivalMod.makeCardPath;
...
public abstract class AbstractSurvivorCard extends CustomCard {
    ...
    public AbstractSurvivorCard(final String id, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        super(id, "ERROR", getCorrectPlaceholderImage(type, id),
                cost, "ERROR", type, TheSurvivor.Enums.SURVIVOR_BROWNIE, rarity, target);
    ...
    public AbstractSurvivorCard(final String id, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        super(id, "ERROR", getCorrectPlaceholderImage(type, id),
    ...
    protected Texture getPortraitImage() {
        if (this.textureImg.contains("Attack"))
    ...
    public void markEnemy(AbstractMonster m, int q) {
        atb(new ApplyMarkAction(q, m));
    }
    ...
    protected void makeInHand(AbstractCard c, int i) {
    ...
    public void distUp(int amount) {
        atb(new DistanceAction(amount));
    }
