...
public class NoDistancePower extends AbstractPower implements CloneablePowerInterface {

    public static final String POWER_ID = SurvivalMod.makeID("NoDistancePower");
    ...
    public NoDistancePower(final int amount) {
        this.name = "No Distance";
        this.ID = POWER_ID;
    ...
    public void updateDescription() {
        description = "You cannot gain Distance this turn.";
    }

    @Override
    public AbstractPower makeCopy() {
        return new NoDistancePower(amount);
    }
}