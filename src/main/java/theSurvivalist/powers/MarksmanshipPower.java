...
public class MarksmanshipPower extends AbstractPower implements CloneablePowerInterface {

    public static final String POWER_ID = SurvivalMod.makeID("MarksmanshipPower");
    ...
    public MarksmanshipPower(final int amount) {
    ...
    public void updateDescription() {
        description = "Whenever you apply #yMark, increase the amount applied by #b" + amount + ".";
    }

    @Override
    public AbstractPower makeCopy() {
        return new MarksmanshipPower(amount);
    }
}