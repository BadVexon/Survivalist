...
public class MartialDefensePower extends AbstractPower implements CloneablePowerInterface {

    public static final String POWER_ID = SurvivalMod.makeID("MartialDefensePower");
    ...
    public MartialDefensePower(final int amount) {
        this.name = "MartialDefense";
        this.ID = POWER_ID;
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        if (card.type == AbstractCard.CardType.ATTACK && DistancePanel.getPow() == DistancePanel.DPOW.CLOSE_RANGE) {
            flash();
    ...
    public void updateDescription() {
        description = "Whenever you play an Attack in Close Range, gain #b" + amount + " #yBlock.";
    }

    @Override
    public AbstractPower makeCopy() {
        return new MartialDefensePower(amount);
    }
}